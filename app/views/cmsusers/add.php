...
<div class="col-md-6 mx-auto">
	<a href="<?php echo URLROOT . "/meetings/index"?>" class="btn btn-light"><i class="fa fa-backward"></i> Back</a>
	
	<div class="card card-body bg-light mt-5">
		
		<h2>Add Meeting</h2>
		<p>Fill out this form to create a new meeting</p>
		
		<form action="<?php echo URLROOT;?>/meetings/add" method="post">
